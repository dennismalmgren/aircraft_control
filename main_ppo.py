...
def main(cfg: DictConfig):
    ...
    # Create optimizers
    actor_optim = torch.optim.Adam(actor_module.parameters(), lr=cfg.optim.lr, eps=1e-5)
    critic_optim = torch.optim.Adam(value_module.parameters(), lr=cfg.optim.lr, eps=1e-5)
