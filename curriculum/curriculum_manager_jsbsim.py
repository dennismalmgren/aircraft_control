from jsbsim_interface.aircraft_simulator import AircraftJSBSimInitialConditions
import random

class CurriculumManagerJsbSim:
    def __init__(self, 
    ...
    def get_initial_conditions(self) -> AircraftJSBSimInitialConditions:
        ...
        initial_conditions = AircraftJSBSimInitialConditions(
